...
function Passaro(alturaJogo) {
    ...
    this.setRot = rot => this.elemento.style.transform = `rotate(${rot}deg)`;
    ...
    this.animar = () => {
        ...
        if (novoY <= 0)
            ...
            this.setY(novoY);
            const inclinacao = voando ? -25 : 15;
            this.setRot(inclinacao);
        }
    };
...
function handleButtonGame(e, colidiu = false) {
    e.preventDefault();
...
function FlappyBird() {
    ...
    const botao = document.querySelector('.buttonGame');
    ...
    this.start = () => {
        const temporizador = setInterval(() => {
            ...
            if (colidiu(passaro, barreiras)) {
                ...
                botao.onclick = e => handleButtonGame(e, true);
            }
        }, 16);
    };
};
